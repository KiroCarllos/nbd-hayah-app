                                    ...
                                    <tbody>
                                        @foreach ($transactions as $transaction)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($transaction->type === 'credit')
                                                        <span class="text-success">+@currency($transaction->amount)</span>
                                                    @else
                                                        <span class="text-danger">-@currency($transaction->amount)</span>
                                                    @endif
                                                </td>
                                                <td>
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-3">@currency($user->wallet_balance)</h3>
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-6 border-end">
                                <h6 class="mb-0">
                                    {{ $transactions->where('type', 'credit')->where('status', 'completed')->count() }}</h6>
                                <small class="text-muted">عمليات شحن</small>
                            </div>
                            <div class="col-6">
                                <h6 class="mb-0">
                                    {{ $transactions->where('type', 'debit')->where('status', 'completed')->count() }}</h6>
                                <small class="text-muted">تبرعات</small>
                            </div>
                        </div>
                        <hr>
                        <div class="text-center">
                            <h6 class="mb-0">@currency($transactions->where('type', 'credit')->where('status', 'completed')->sum('amount'))</h6>
