        ...
        <div class="col-md-3">
            <div class="card stats-card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4>{{ number_format($transactions->where('type', 'charge')->sum('amount'), 0) }} ج.م</h4>
        ...
        <div class="col-md-3">
            <div class="card stats-card bg-danger text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4>{{ number_format($transactions->where('type', 'donation')->sum('amount'), 0) }} ج.م</h4>
        ...
        <div class="col-md-3">
            <div class="card stats-card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4>{{ number_format($transactions->avg('amount'), 0) }} ج.م</h4>
                            ...
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-{{ $badgeConfig['class'] }} d-flex align-items-center gap-1"
                                    ...
                                    <td>
                                        ...
                                        @else
                                            @if ($transaction->status != 'completed' && $transaction->description == 'شحن المحفظة')
                                                <span
                                                    class="text-secondary fw-bold">{{ number_format($transaction->amount, 2) }}
                                                    ج</span>
                                            @else
                                                <span
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            @if ($transaction->type === 'donation' && $transaction->description)
                                                <button type="button" class="btn btn-sm btn-outline-info"
                                                    data-bs-toggle="tooltip" title="{{ $transaction->description }}">
