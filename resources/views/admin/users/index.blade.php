    ...
    <div class="col-md-3">
        <div class="card stats-card bg-info text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4>{{ number_format($users->sum('wallet_balance'), 0) }} ر.س</h4>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                @if($user->profile_image)
                                    <img src="{{ asset('storage/' . $user->profile_image) }}" alt="Profile" class="rounded-circle me-3" width="40" height="40" style="object-fit: cover;">
                                @else
                        ...
                        <td>{{ $user->mobile }}</td>
                        <td>
                            <span class="badge bg-success">{{ number_format($user->wallet_balance, 2) }} ر.س</span>
                        </td>
                        <td>
