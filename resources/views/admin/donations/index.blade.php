    ...
    <div class="col-md-3">
        <div class="card stats-card bg-success text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4>{{ number_format($donations->sum('amount'), 0) }} ر.س</h4>
    ...
    <div class="col-md-3">
        <div class="card stats-card bg-warning text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4>{{ number_format($donations->avg('amount'), 0) }} ر.س</h4>
                    ...
                    <tr>
                            ...
                            @else
                                <div class="d-flex align-items-center">
                                    @if($donation->user->profile_image)
                                        <img src="{{ asset('storage/' . $donation->user->profile_image) }}" alt="Profile" class="rounded-circle me-3" width="40" height="40" style="object-fit: cover;">
                                    @else
                                        <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle me-3" style="width: 40px; height: 40px;">
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('campaigns.show', $donation->campaign) }}" class="btn btn-sm btn-outline-info" target="_blank">
                                    <i class="bi bi-eye"></i>
                                </a>
                                @if(!$donation->is_anonymous)
                                <a href="{{ route('admin.users.show', $donation->user) }}" class="btn btn-sm btn-outline-primary">
