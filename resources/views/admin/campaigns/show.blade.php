    ...
    <div class="col-md-8">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div id="campaignImagesCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <img src="{{ asset('storage/' . $image) }}" class="d-block w-100 rounded" alt="{{ $campaign->title }}" style="height: 400px; object-fit: cover;">
                        </div>
                        @endforeach
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#campaignImagesCarousel" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">السابق</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#campaignImagesCarousel" data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">التالي</span>
                    </button>
                    <div class="carousel-indicators">
                        @foreach($campaign->images as $index => $image)
                        <button type="button" data-bs-target="#campaignImagesCarousel" data-bs-slide-to="{{ $index }}" 
                ...
                @else
                <img src="{{ asset('storage/' . $campaign->images[0]) }}" class="img-fluid rounded" alt="{{ $campaign->title }}" style="width: 100%; height: 400px; object-fit: cover;">
                @endif
            </div>
        </div>
        @endif
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <a href="{{ route('admin.donations.index') }}?campaign={{ $campaign->id }}" class="btn btn-outline-primary">
                        عرض جميع التبرعات
                    </a>
                </div>
                @endif
            ...
            <div class="card-body">
                <div class="row text-center mb-3">
                    <div class="col-6">
                        ...
                        <small class="text-muted">ر.س محصل</small>
                    </div>
                    <div class="col-6">
                        <h3 class="text-primary">{{ number_format($campaign->target_amount, 0) }}</h3>
                        <small class="text-muted">ر.س مستهدف</small>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-6">
                        <h4 class="text-warning">{{ number_format($campaign->target_amount - $campaign->current_amount, 0) }}</h4>
                        <small class="text-muted">ر.س متبقي</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mb-3">
                    @if($campaign->creator->profile_image)
                        <img src="{{ asset('storage/' . $campaign->creator->profile_image) }}" alt="Creator" class="rounded-circle me-3" width="50" height="50" style="object-fit: cover;">
                    @else
                        <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle me-3" style="width: 50px; height: 50px;">
                            <i class="bi bi-person text-white"></i>
                        </div>
                    @endif
                    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('campaigns.show', $campaign) }}" class="btn btn-outline-primary" target="_blank">
                    ...
                    <form action="{{ route('admin.campaigns.destroy', $campaign) }}" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذه الحملة؟ سيتم حذف جميع التبرعات المرتبطة بها.')">
                        @csrf
                        @method('DELETE')
