                    ...
                    <form method="POST" action="{{ route('admin.campaigns.update', $campaign) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('target_amount') is-invalid @enderror"
                                ...
                                value="{{ old('target_amount', $campaign->target_amount) }}" min="1" step="0.01"
                                required>
                            @error('target_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <select class="form-select @error('creator_id') is-invalid @enderror" id="creator_id"
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}"
                                        {{ old('creator_id', $campaign->creator_id) == $user->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-3 mb-2">
                                            <div class="position-relative">
                                                ...
                                                <div class="form-check position-absolute top-0 end-0 m-1">
                                                    <input type="checkbox" class="form-check-input bg-danger"
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_priority" name="is_priority"
                                        value="1" {{ old('is_priority', $campaign->is_priority) ? 'checked' : '' }}>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6">
                            <h4 class="text-success">{{ number_format($campaign->current_amount, 0) }}ج.م</h4>
