                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between mb-1">
                                            <small class="text-muted">المحصل: {{ number_format($campaign->current_amount, 2) }} ر.س</small>
                                            <small class="text-muted">الهدف: {{ number_format($campaign->target_amount, 2) }} ر.س</small>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            @if($campaign->creator->profile_image)
                                                <img src="{{ asset('storage/' . $campaign->creator->profile_image) }}" 
                                                     alt="Creator" class="rounded-circle me-2" width="24" height="24">
                                            @else
