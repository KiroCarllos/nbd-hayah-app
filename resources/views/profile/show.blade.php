            ...
            <div class="col-md-4">
                ...
                <div class="card mt-4">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 text-success">@currency($user->wallet_balance)</h3>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-warning text-white">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4>@currency($stats['total_charged_amount'])</h4>
                                    ...
                                    <tbody>
                                        @foreach ($recent_transactions as $transaction)
                                            <tr>
                                                ...
                                                <td>{{ \Illuminate\Support\Str::limit($transaction->description, 30) }}
                                                </td>
                                                <td>
                                                    @if ($transaction->type === 'credit')
